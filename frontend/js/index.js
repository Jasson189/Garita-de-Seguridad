    ...
    const inputCodigoUnico =
        document.getElementById("codigo_unico") ||
        document.getElementById("codigoVecino") ||
        document.getElementById("codigo_unico_vecino") ||
        document.getElementById("codigoVecinoInput");
    ...
    function renderTabla(data) {
        ...
        data.forEach(function (visita, indice) {
            ...
            const estadoAutorizacion =
                visita.estado_autorizacion_vecino ||
                "pendiente_vecino";

            let textoAutorizacion = "Pendiente del vecino";
            let claseAutorizacion = "badge-pendiente";

            if (estadoAutorizacion === "autorizada") {
                textoAutorizacion = "Autorizada por vecino";
                claseAutorizacion = "badge-autorizada";
            }

            if (estadoAutorizacion === "rechazada") {
                textoAutorizacion = "Rechazada por vecino";
                claseAutorizacion = "badge-rechazada";
            }
            ...
            fila.innerHTML = `
                ...
                <td>
                    ...
                    <span class="badge-autorizacion ${claseAutorizacion}">
                        ${textoAutorizacion}
                    </span>
                </td>
                ...
                <td>
                    ${
                        estadoAutorizacion === "rechazada"
                            ? `<span class="muted">Ingreso rechazado</span>`
                            : estaActiva
    ...
    async function registrarVisita() {
        ...
        const codigoUnico = inputCodigoUnico ? inputCodigoUnico.value.trim().toUpperCase() : "";
        ...
        if (!codigoUnico) {
            mostrarMensaje("Ingrese el código único del vecino.", "error");
            return;
        }
